...
class Settings(BaseSettings):
    ...
    engine_operator_proposals_enabled: bool = True
    engine_operator_min_net_ev_bps: float = 12.0
    engine_operator_min_risk_adjusted_utility: float = 0.35
    engine_operator_min_confidence: float = 0.55
    engine_operator_min_feature_coverage_pct: float = 80.0
    engine_operator_max_proposals_per_loop: int = 3
    engine_operator_max_proposals_per_day: int = 10
    engine_operator_proposal_ttl_minutes: int = 30
    engine_operator_symbol_cooldown_minutes: int = 30
    engine_operator_shadow_digest_enabled: bool = True
    engine_operator_shadow_digest_interval_seconds: int = 21600
